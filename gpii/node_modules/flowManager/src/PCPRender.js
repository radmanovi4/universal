    ...
    gpii.request.flowManager.pcpRenderHandle = function (that, socket, pcpInterface) {
        ...
        var payload1 = {
            settings: {
                "org.alsa-project": {
                    settings: {
                        "http://registry.gpii.net/applications/org.alsa-project/masterVolume": 11111111
                    }
                }
            }
        };
        var payload2 = {
            settings: {
                "org.alsa-project": {
                    settings: {
                        "http://registry.gpii.net/applications/org.alsa-project/masterVolume": 2222222222
                    }
                }
            }
        };
        ...
        socket.emit("message", mes1);
        setTimeout(function () {
            socket.emit("message", payload1);
        }, 4000);

        setTimeout(function () {
            socket.emit("message", mes2);
        }, 7000);
