...
(function () {
    ...
    gpii.request.flowManager.onUserLogin = function (userToken, handler, pcpUrl) {
        handler.userToken = userToken;
        handler.events.onUserToken.fire(userToken);
        // open(pcpUrl);
    };

    gpii.request.flowManager.startLifecycle = function (flowManager, lifecycleManager, lifecyclePayload, sessionData, event) {
    ...
    fluid.defaults("kettle.requests.request.handler.userLogin", {
        ...
        invokers: {
            startLifecycle: {
                ...
                args: [ "{flowManager}", "{flowManager}.lifecycleManager", "{arguments}.0", "{arguments}.1", "{requestProxy}.events.onSuccess" ]
            ...
            handle: {
                ...
                args: ["{request}.req.params.userToken", "{that}", "{flowManager}.options.urls.pcp"],
                dynamic: true
            },
            runContextManager: {
