...
(function () {
    ...
    var firstUpdateConfiguration = [{
        "id": "org.gnome.desktop.a11y.magnifier",
        "settingsHandlers": [{
            "type": "gpii.tests.lifecycleManager.mockSettingsHandlerOnFirstUpdate"
        }]
    }];

    var secondUpdateConfiguration = [{
        "id": "org.gnome.desktop.a11y.magnifier",
        "settingsHandlers": [{
            "type": "gpii.tests.lifecycleManager.mockSettingsHandlerOnSecondUpdate"
        }]
    }];
    ...
    gpii.tests.lifecycleManager.mockSettingsHandlerOnFirstUpdate = function () {
        return {
            "org.gnome.desktop.a11y.magnifier": [{
                "settings": {
                    "cross-hairs-clip": {
                        "oldValue": false,
                        "newValue": "valueOnFirstUpdate"
                    }
                }
            }]
        };
    ...
    gpii.tests.lifecycleManager.mockSettingsHandlerOnSecondUpdate = function () {
        return {
            "org.gnome.desktop.a11y.magnifier": [{
                "settings": {
                    "cross-hairs-clip": {
                        "oldValue": "valueOnFirstUpdate",
                        "newValue": "valueOnSecondUpdate"
                    },
                    "mag-factor": {
                        "oldValue": 100,
                        "newValue": 250
    ...
    var firstUpdateHandlersExpectedResponse = {
        "cross-hairs-clip": false,
        "cross-hairs-color": "red"
    };

    var secondUpdateHandlersExpectedResponse = {
        "cross-hairs-clip": false,
        "cross-hairs-color": "red",
        "mag-factor": 100
    };
    ...
    gpii.tests.lifecycleManager.runTests = function () {
        ...
        jqUnit.test("gpii.lifecycleManager.update() with proper activeSession merging", function () {
            jqUnit.expect(4);
            ...
            lifecycleManager.update(gpii.tests.lifecycleManager.userOptions, firstUpdateConfiguration, function () {
                ...
                jqUnit.assertDeepEq("update() doesn't overwrite the initial settingsHandlers, thus logging out would work properly.", firstUpdateHandlersExpectedResponse, sessionSolutions[0].settingsHandlers[0].settings);
            });
            var sessionSolutions = lifecycleManager.activeSessions[gpii.tests.lifecycleManager.userOptions.userToken].solutions;
            lifecycleManager.update(gpii.tests.lifecycleManager.userOptions, secondUpdateConfiguration, function () {

                jqUnit.assertDeepEq("update() adds the initial state of a newly changed setting in solution.settingsHandlers and preserves the oldest ones for all multiply changed settings", secondUpdateHandlersExpectedResponse, sessionSolutions[0].settingsHandlers[0].settings);
            });
        });
    };
}());
