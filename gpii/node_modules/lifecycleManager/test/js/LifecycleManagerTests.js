...
(function () {
    ...
    var configurationSpec1 = [{
        "id": "org.gnome.desktop.a11y.magnifier",
        "settingsHandlers": [{
            "type": "gpii.tests.lifecycleManager.mockSettingsHandler1",
        }]
    }];

    var configurationSpec2 = [{
        "id": "org.gnome.desktop.a11y.magnifier",
        "settingsHandlers": [{
            "type": "gpii.tests.lifecycleManager.mockSettingsHandler2",
        }]
    }];
    ...
    gpii.tests.lifecycleManager.mockSettingsHandler1 = function () {
        return {
            "org.gnome.desktop.a11y.magnifier": [{
                "settings": {
                    "cross-hairs-clip": {
    ...
    gpii.tests.lifecycleManager.mockSettingsHandler2 = function () {
        return {
            "org.gnome.desktop.a11y.magnifier": [{
                "settings": {
                    "cross-hairs-clip": {
    ...
    gpii.tests.lifecycleManager.runTests = function () {
        ...
        jqUnit.test("gpii.lifecycleManager.update() with proper activeSession merging", function () {
            ...
            lifecycleManager.update(gpii.tests.lifecycleManager.userOptions, configurationSpec1, function () {
            ...
            var sessionSolutions = lifecycleManager.activeSessions[gpii.tests.lifecycleManager.userOptions.userToken].solutions;
            lifecycleManager.update(gpii.tests.lifecycleManager.userOptions, configurationSpec2, function () {
